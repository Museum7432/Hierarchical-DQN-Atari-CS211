...
def train_dqn(
    ...
    while global_step < total_timesteps:
        ...
        if truncation:
            # treat truncation like termination
            # there isn't any truncation in atari game
            # so this haven't been tested
...
def train_Hdqn(
    ...
    while global_step < total_timesteps:
        ...
        while not done and not goal_reached:
            ...
            if rb_meta.size() > learning_starts:
